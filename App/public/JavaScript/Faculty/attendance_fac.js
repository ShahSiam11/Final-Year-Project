...
const toPDF = function (customers_table) {
  const html_code = `
    ...
    <head>
      ...
      <link rel="stylesheet" type="text/css" href="/CSS/Faculty/attendance_fac.css">
      <style>
        /* Set landscape mode if your table is wide */
        @page { size: landscape; }
        /* Optional: adjust margins/padding for print */
        body, main {
          margin: 0;
          padding: 0;
        }
  ...
  // Open a new window and write the full HTML
